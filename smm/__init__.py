...
from .protocols.smm_sw_dispatch2_protocol import EFI_SMM_SW_CONTEXT
import ctypes
...
region is already occupied")
        ...
        self.register_context = ql.os.heap.alloc(0x1000)
        self.communication_buffer = ql.os.heap.alloc(0x1000)
